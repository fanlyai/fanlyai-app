...
const ChatbotCard : React.FC<ChatbotsProps> = ({ image, name,user,assistantId,role,description,onClick }) =>
{
    return (
      <div className={`bg-[#3f3f3f] cursor-pointer mt-8 min-h-[150px] md:min-h-[300px] lg:min-h-[200px] space-x-2 transform transition duration-200 hover:scale-105 md:px-4 py-2 border border-[#575757] rounded-lg flex md:flex-row flex-col md:items-center`}>
